...
if __name__ == "__main__":
    ...
    print(" Loading ASCADrL Desync0 dataset (TRAINING MODE)...")
    (X_profiling, Y_profiling), (X_validation, Y_validation), _ = load_ascad(
        ASCAD_data_folder + "atmega8515-raw-traces_20k_desync0.h5",
        load_metadata=False,
    ...
    model_name = f"InceptionNet_APS_ascadrL_desync0_20k_epochs{epochs}_batchsize{batch_size}.h5"
